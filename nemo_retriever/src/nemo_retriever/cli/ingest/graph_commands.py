...
def _graph_ingest_command(
    ...
    line_detector_invoke_url: opts.LineDetectorInvokeUrlOption = None,
    ocr_recognizer_invoke_url: opts.OcrRecognizerInvokeUrlOption = None,
    vietnamese_ocr_invoke_url: opts.VietnameseOcrInvokeUrlOption = None,
